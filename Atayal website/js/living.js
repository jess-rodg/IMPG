...
let a = document.getElementById("liv2");
a.style.display = "none";
document.getElementById("earring").addEventListener("click", () => {
...
let b = document.getElementById("liv3");
...
document.getElementById("sleeveless").addEventListener("click", () => {
...
let e = document.getElementById("liv6");
